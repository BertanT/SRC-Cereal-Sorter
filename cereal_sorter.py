...
DEFAULT_MODEL_PATH = 'cereal_edgetpu.tflite'
DEFAULT_LABEL_PATH = 'cereal_edgetpu_labels.txt'
...
def main():
    ...
    try:
        while True:
            ...
            if prev_object_id == object_id or not prev_object_id:
                debounce_counter += 1
            else:
                debounce_counter = 0
            ...
            if debounce_counter < 30:
                continue

            debounce_counter = 0

            if object_id == "control":
                print("\n  * Sorter is empty!")
                pass
            else:
                vibration_motor.value = False
                if object_id == "cheerios":
                    print("\n  * Found Cheerios!")
                    servo_motor.angle = 0
                elif object_id == "cocoa_puffs":
                    print("\n  * Found Cocoa Puffs!")
